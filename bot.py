"""
A Python script that allows to chat with the
Cognitive Behavior Therapy (CBT) Chatbot via
the console. Simply run the bot.py file to test
the bot, once all setup is completed.
...
try:
    ...
    print(e)
vocab = Dictionary.load('Models/Bot_Vocab_Sentiment')
